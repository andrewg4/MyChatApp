...
import ua.com.prologistic.data.ChatAdapter;
import ua.com.prologistic.model.Message;
import ua.com.prologistic.util.ProgressGenerator;
...
public class ChatActivity extends AppCompatActivity {
    ...
    public static final int MAX_CHAT_MSG_TO_SHOW = 70;
        ...
        query.findInBackground(new FindCallback<Message>() {
            ...
            public void done(List<Message> messages, ParseException e) {
                if (e == null) {
                    ...
                    listView.invalidate();// allows for the list to be redraw
                } else {
